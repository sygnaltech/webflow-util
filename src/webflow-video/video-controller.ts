...
interface Sa5VideoControllerConfig {
...
export class Sa5VideoController {

    config: Sa5VideoControllerConfig;
...
//    modalRule: ModalRule = ModalRule.Default; 
    ...
    constructor(config: Partial<Sa5VideoControllerConfig> = {}) {

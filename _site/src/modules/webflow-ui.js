...
export var setRating = function (el, rating) {

    el.attr("wfu-rating", rating);
    renderRatingComponent(el);

}

// Process an element, turning it into a WFU Rating Component
export var renderRatingComponent = function (el) {

    var ratingValue = el.attr("wfu-rating");

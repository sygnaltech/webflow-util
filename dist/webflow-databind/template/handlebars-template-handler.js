(() => {
      ...
      var logger = {
        ...
        log: function log(level) {
          ...
          if (typeof console !== "undefined" && logger.lookupLevel(logger.level) <= level) {
            ...
            for (var _len2 = arguments.length, message = Array(_len2 > 1 ? _len2 - 1 : 0), _key = 1; _key < _len2; _key++) {
  ...
  var require_create_new_lookup_object = __commonJS({
    "node_modules/handlebars/dist/cjs/handlebars/internal/create-new-lookup-object.js"(exports) {
      ...
      function createNewLookupObject() {
        for (var _len2 = arguments.length, sources = Array(_len2), _key = 0; _key < _len2; _key++) {
  ...
  // src/webflow-databind/template/handlebars-template-handler.ts
  var Handlebars = require_handlebars();
  var HandlebarsTemplateHandler = class extends DefaultTemplateHandler {
    processElement(elem) {
      let html = elem.innerHTML;
